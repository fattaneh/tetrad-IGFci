...
//
//public class RBExperimentsLocal {
//
//	private int depth = 5;
...
//		double alpha = 0.05, numLatentConfounders = 0.1, lower = 0.3, upper = 0.7;
//		int numCases = 2000, numModels = 100, numBootstrapSamples = 500, round = 0;
//		String modelName = "Alarm.xdsl", filePath = "/Users/fattanehjabbari/CCD-Project/CS-BN/bsc-results/",
...
//		RBExperimentsLocal DFC = new RBExperimentsLocal();
//		DFC.directory = dataPath;
//		double[] lv = new double[]{0.1};//, 0.1, 0.2};
//		int[] cases = new int[]{2000};//, 200};
...
//
//		Map<NodePair, Map<Graph, BayesIm>> localBNs =  learnLocalBNs(data.getVariables(), depData, H, lower, upper);
//		
////		System.out.println("localBNs: " + localBNs);
//		System.out.println("Local dependency graphs done!");
//
//		// compute scores of graphs that are output by RB search using BSC-I and
//		// BSC-D methods
//		start = System.currentTimeMillis();
//		allScores lnProbs = getLnProbsAll(bscPags, H, data, localBNs);
...
//	}
//
//	private allScores getLnProbsAll(List<Graph> pags, Map<IndependenceFact, Double> H, DataSet data,
//			Map<NodePair, Map<Graph, BayesIm>> localBNs) {
//		
...
//
//				// Filtering
//				double lnDep = getLnProbUsingDepFiltering(pagOrig, H, localBNs);
...
//	// }
//
//	private double getLnProbUsingDepFiltering(Graph pag, Map<IndependenceFact, Double> H, 
//			Map<NodePair, Map<Graph, BayesIm>> localBNs) {
//		double lnQ = 0;
//
//		for (IndependenceFact fact : H.keySet()) {
...
//        	Map<Graph, BayesIm> relevant_BN = localBNs.get(ab);
//        	BayesIm im = null;
//        	if (relevant_BN != null){
//        		for (Graph key : relevant_BN.keySet()){
//        			im = relevant_BN.get(key);
//        		}
//        	}
...
//	}
//	
//	private Map<NodePair, Map<Graph, BayesIm>> learnLocalBNs(List<Node> variables, DataSet depData, Map<IndependenceFact, Double> H, double lower, double upper){
//		
//		Map<NodePair, Map<Graph, BayesIm>> localBNs = new HashMap<>();
//
...
//            		Map<Graph, BayesIm> g_theta= new HashMap<>();
...
//			if (((NodePair) O).n_a != n_a) return false;
//			if (((NodePair) O).n_b != n_b) return false;
//			return true;
//		}
////		 @Override
////		 public int hashCode() {
