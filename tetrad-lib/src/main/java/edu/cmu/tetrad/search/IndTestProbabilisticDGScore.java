 ...
 */
public class IndTestProbabilisticDGScore implements IndependenceTest {

    /**
     * Calculates probabilities of independence for conditional independence facts.
     */
//    private final BCInference bci;
    private DegenerateGaussianScore score;
     ...
     */
    public IndTestProbabilisticDGScore(DataSet dataSet) {
    	 if (!(dataSet.isMixed())) {
        ...
        this.score = new DegenerateGaussianScore(data);

        this.nodes = this.data.getVariables(); //dataSet.getVariables();
