...
//        throw new IllegalArgumentException("Unsupported edge type : " + edgeTop);
    ...
    public static class GraphComparison {
        ...
        public GraphComparison(List<Edge> edgesAddedIS, List<Edge> edgesAddedOther, List<Edge> edgesAdded,
				List<Edge> edgesRemovedIS, List<Edge> edgesRemovedOther,List<Edge> edgesRemoved,
				List<Edge> edgesReorientedFromIS, List<Edge> edgesReorientedFromOther,List<Edge> edgesReorientedFrom,
				List<Edge> edgesReorientedToIS, List<Edge> edgesReorientedToOther,List<Edge> edgesReorientedTo,
				int[][] counts) {
